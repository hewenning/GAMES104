...
#include <special_effect_frag.h>
#include <post_process_vert.h>

namespace Pilot
{
    void PSpecialEffectPass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PSpecialEffectPass::setupDescriptorSetLayout()
    {
    ...
    void PSpecialEffectPass::setupPipelines()
    {
        ...
        VkShaderModule frag_shader_module =
            PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, SPECIAL_EFFECT_FRAG);
        ...
        pipelineInfo.subpass             = _main_camera_subpass_special_effect;
    ...
    void PSpecialEffectPass::setupDescriptorSet()
    {
    ...
    void PSpecialEffectPass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
    ...
    void PSpecialEffectPass::draw()
    {
        if (m_render_config._enable_debug_untils_label)
        {
            VkDebugUtilsLabelEXT label_info = {
                VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT, NULL, "Special Effect", {1.0f, 1.0f, 1.0f, 1.0f}};
